        ...
        <div id="input-addresses">
          ...
          <form action="/homes" method="post">
            ...
            <div className="trans-button round-edges-50">
              <label className="label_item"><img width="50px" src="http://neighborhome.herokuapp.com/assets/bus-c99280cf73c3ded2ae092a20c4e9b99df925fa29aebec929d4be21b4db4101f8.png" alt="Bus" /></label>
            </div>
            <div className="trans-button round-edges-50">
              <label className="label_item"><img width="50px" src="http://neighborhome.herokuapp.com/assets/car-6c964c3c0c0b69fb8c81a51c4a35df4bcff9d8b62ac85bb62e84d6245b88d2d5.jpg" alt="Car" /></label>
            </div>
            <div className="trans-button round-edges-50">
              <label className="label_item"><img width="50px" src="http://neighborhome.herokuapp.com/assets/person-28c586a20e61e355b8000ba0a4d295eb8b09628e08522283b028e13d8639014b.jpg" alt="Person" /></label>
            </div>
            <div className="trans-button round-edges-50">
              <label className="label_item"><img width="50px" src="http://neighborhome.herokuapp.com/assets/bike-50e8514251189d8686b8d6f765f3eda7dfd2b9f63a7d5ee5bd81216b74637f74.jpg" alt="Bike" /></label>
            </div>
            <div  >
            </div>
          </form>
        </div>
        <div id="return-addresses">
        </div>
      </div>
    );
  }
});
ReactDOM.render(<Root name='Root'/>, document.getElementById('container'));
...
//
// <script src="/assets/application-dd7099294953d4056c6dc00ffb68511d72f5e9b5d9c1d0aa0aa257de536021ed.js"></script>
...
//
//   var map = L.mapbox.map('map').setView([39.737074, -104.953460], 12);
// </script>
